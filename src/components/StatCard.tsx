...
export default function StatCard({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-card overflow-hidden flex transition-shadow duration-200 hover:shadow-card-lg">
      {/* Left accent bar */}
